...
Mothership にインポート完了（雛形コピーのみ・DL-G 化未着手）。
...
> ※ 上記はすべて OSSDB プロジェクトからの流用。タイトル等は OSS-DB のままで DL-G 表記ではない。
...
- [ ] DL-G 用問題データの差し替え
- [ ] アプリ内のテキスト/メタデータの DL-G 化（title, manifest, CACHE_NAME, LocalStorage キー）
- [ ] アイコンの差し替え（任意）
- [ ] iOS / Android 実機検証
...
- **GitHub 公開**:
  - リポジトリ: <https://github.com/markn333/DL-G>
  - 公開 URL: <https://markn333.github.io/DL-G/>

### 2026-04-25
- アプリを DL-G 用にリブランド（title / manifest / CACHE_NAME / LocalStorage キー）
